...
int main(int argc, char *argv[])
{
    ...
    cout<< "Sender's public key = " << Pa << endl;    
    ...
    cout<< "Receiver's public key = " << Pb << endl;    
    ...
    cout<< "*************************************************\n";
    cout<< "* Your input message points : ("<< message_x << ", "<< message_y << ")\n";
    cout<< "*************************************************\n\n";
    ...
    cout<< "\n*********************************************";
    cout<< "\n* Decrypted message points = (" << message_xd << ", " << message_yd <<")   " ;
    cout<< "\n*********************************************\n\n";

    //cout<< "\n==============================================================\n"; 
    cout<< "--------Decrypted points are equal to the given message  points--------";
    //cout<< "\n==============================================================\n"; 
    cout<< endl;
